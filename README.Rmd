...
```{r climatestripes, fig.asp=0.7, eval=FALSE}
...
```{r echo=FALSE}
knitr::include_graphics("man/figures/README-climatestripes-1.png")
```
...
```{r windrose, fig.asp=0.7, eval=FALSE}
...
```{r echo=FALSE}
knitr::include_graphics("man/figures/README-windrose-1.png")
```
...
print(citation("climaemet")[1], bibtex = FALSE)
```
