...
Geostatistical data arise when the domain under study is a fixed set $D$ that
...
There are several **R** packages for geostatistical analysis, but there are
"two big ones": **geoR** [@ribeirojr2001] and **gstat** [@pebesma2004;
@graler2016].
...
parameters of the semivariogram. It can help you fit the empirical
...
again, we apply the approach described in
