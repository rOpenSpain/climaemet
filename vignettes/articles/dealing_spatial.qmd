...
**they must meet a series of requirements.** As we only have the observed
...
function, $Z(s)$, at one or more unobserved points (or blocks) from a
...
(BLUP) of the regionalized variable under study at such unobserved points or
blocks
...
other hand, stochastic interpolation techniques like kriging use the
