...
There are several **R** packages for geostatistical analysis, but there are "two
big ones": **geoR** [@ribeirojr2001] and **gstat** [@pebesma2004; @graler2016].
...
points using an inverse distance function of neighboring points. On the
contrary, stochastic interpolation techniques like kriging utilize the
