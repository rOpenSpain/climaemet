...
description: Interactive map of the available AEMET stations
date: "`r Sys.Date()`"
knitr:
  opts_chunk:
    collapse: true
...
This annex shows an interactive and searchable version of the results returned
by `climaemet::aemet_stations()` as of **`r format(Sys.Date(),"%d %b %Y")`**:
