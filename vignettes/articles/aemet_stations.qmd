...
description: Explore weather stations available from AEMET
date: "`r Sys.Date()`"
knitr:
  opts_chunk:
    collapse: true
...
This article provides an interactive map and searchable table of the weather
stations returned by `aemet_stations()` as of
