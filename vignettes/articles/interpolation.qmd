...
Data](https://opendata.aemet.es/centrodedescargas/inicio). However, for spatial
However, for spatial analysis and visualization it can be useful to extend the
point data to cover the whole extent of Spain. In this article we explain a
...
As it can be seen, the climatic data we have available so far is restricted to
...
we need to interpolate the data. In this example we use the **terra** package
and apply the [Inverse Distance Weighted
