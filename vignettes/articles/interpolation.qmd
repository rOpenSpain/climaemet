...
We use daily climatic data for winter 2020–2021 in Spain. Note that in the first
...
As shown above, the climatic data available so far are restricted to stations
...
this in detail in this article, but we should mention a few key considerations:
