...
**climaemet** can retrieve data from weather stations available through the
[AEMET API](https://opendata.aemet.es/centrodedescargas/inicio). For spatial
...
example, we use the **terra** package and apply [inverse distance weighting
...
predict. A common approach is to create a spatial grid, or raster, that covers
the target area.
