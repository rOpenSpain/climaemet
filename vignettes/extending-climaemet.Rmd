...
#>  1 0301101  Raco de l'Albir          03           Alacant/Alicante 03011        l'Alfàs del Pi   "38º 3… "-00º 0…
#>  2 0301401  Sant Joan / San Juan     03           Alacant/Alicante 03014        Alicante/Alacant "38º 2… "-00º 2…
#>  3 0301408  El Postiguet             03           Alacant/Alicante 03014        Alicante/Alacant "38º 2… "-00º 2…
#>  4 0301410  Saladar                  03           Alacant/Alicante 03014        Alicante/Alacant "38º 1… "-00º 3…
#>  5 0301808  La Roda                  03           Alacant/Alicante 03018        Altea            "38º 3… "-00º 0…
#>  6 0301809  Cap Blanch               03           Alacant/Alicante 03018        Altea            "38º 3… "-00º 0…
#>  7 0303102  Llevant / Playa de Leva… 03           Alacant/Alicante 03031        Benidorm         "38º 3… "-00º 0…
#>  8 0303104  Ponent / Playa de Ponie… 03           Alacant/Alicante 03031        Benidorm         "38º 3… "-00º 0…
#>  9 0304105  Cala Fustera             03           Alacant/Alicante 03041        Benissa          "38º 3… "0º 05'…
#> 10 0304704  La Fossa                 03           Alacant/Alicante 03047        Calp             "38º 3… "0º 04'…
#> # ℹ 581 more rows
```
...
#> $ elaborado  <chr> "2024-06-21T08:00:22"
...
#> $ fecha       <int> 20240621, 20240622, 20240623
#> $ tmaxima     <df[,2]> <data.frame[3 x 2]>
#> $ stermica    <df[,3]> <data.frame[3 x 3]>
#> $ tagua       <df[,2]> <data.frame[3 x 2]>
```
...
#> $ elaborado                <dttm> 2024-06-21 08:00:22, 2024-06-21 08:00:22, 2024-06-21 08:00:22
#> $ fecha                    <date> 2024-06-21, 2024-06-22, 2024-06-23
#> $ estadoCielo_value        <chr> "", "", ""
#> $ estadoCielo_f1           <int> 100, 100, 100
#> $ estadoCielo_descripcion1 <chr> "despejado", "despejado", "despejado"
#> $ estadoCielo_f2           <int> 100, 110, 100
#> $ estadoCielo_descripcion2 <chr> "despejado", "nuboso", "despejado"
#> $ viento_value             <chr> "", "", ""
...
#> $ fecha                    <date> 2024-06-21, 2024-06-22, 2024-06-23
#> $ estadoCielo_value        <chr> "", "", ""
#> $ estadoCielo_f1           <int> 100, 100, 110
#> $ estadoCielo_descripcion1 <chr> "despejado", "despejado", "nuboso"
#> $ estadoCielo_f2           <int> 100, 120, 100
#> $ estadoCielo_descripcion2 <chr> "despejado", "muy nuboso", "despejado"
#> $ viento_value             <chr> "", "", ""
#> $ viento_f1                <int> 210, 210, 210
#> $ viento_descripcion1      <chr> "flojo", "flojo", "flojo"
...
#> $ oleaje_f1                <int> 310, 310, 310
#> $ oleaje_descripcion1      <chr> "débil", "débil", "débil"
#> $ oleaje_f2                <int> 320, 310, 320
#> $ oleaje_descripcion2      <chr> "moderado", "débil", "moderado"
#> $ tMaxima_value            <chr> "", "", ""
#> $ tMaxima_valor1           <int> 28, 28, 27
#> $ sTermica_value           <chr> "", "", ""
#> $ sTermica_valor1          <int> 460, 460, 460
#> $ sTermica_descripcion1    <chr> "calor agradable", "calor agradable", "calor agradable"
#> $ tAgua_value              <chr> "", "", ""
#> $ tAgua_valor1             <int> 23, 24, 24
#> $ uvMax_value              <chr> "", "", ""
#> $ uvMax_valor1             <int> 9, 9, 9
#> $ tmaxima_value            <chr> "", "", ""
#> $ tmaxima_valor1           <int> 28, 28, 27
#> $ stermica_value           <chr> "", "", ""
#> $ stermica_valor1          <int> 460, 460, 460
...
#> Rows: 12
#> Columns: 34
#> $ id_beach                 <int> 303102, 303102, 303102, 303104, 303104, 303104, 304105, 304105, 304105, 304704…
#> $ elaborado                <dttm> 2024-06-21 08:00:22, 2024-06-21 08:00:22, 2024-06-21 08:00:22, 2024-06-21 08:…
#> $ fecha                    <date> 2024-06-21, 2024-06-22, 2024-06-23, 2024-06-21, 2024-06-22, 2024-06-23, 2024-…
#> $ estadoCielo_value        <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ estadoCielo_f1           <int> 100, 100, 110, 100, 100, 110, 100, 100, 110, 100, 100, 110
#> $ estadoCielo_descripcion1 <chr> "despejado", "despejado", "nuboso", "despejado", "despejado", "nuboso", "despe…
#> $ estadoCielo_f2           <int> 100, 120, 100, 100, 120, 100, 100, 120, 100, 100, 120, 100
#> $ estadoCielo_descripcion2 <chr> "despejado", "muy nuboso", "despejado", "despejado", "muy nuboso", "despejado"…
#> $ viento_value             <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ viento_f1                <int> 210, 210, 210, 210, 210, 210, 210, 210, 210, 210, 210, 210
#> $ viento_descripcion1      <chr> "flojo", "flojo", "flojo", "flojo", "flojo", "flojo", "flojo", "flojo", "flojo…
#> $ viento_f2                <int> 220, 210, 210, 220, 210, 210, 210, 220, 210, 210, 220, 210
#> $ viento_descripcion2      <chr> "moderado", "flojo", "flojo", "moderado", "flojo", "flojo", "flojo", "moderado…
#> $ oleaje_value             <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ oleaje_f1                <int> 320, 310, 310, 320, 310, 310, 320, 310, 310, 320, 310, 310
#> $ oleaje_descripcion1      <chr> "moderado", "débil", "débil", "moderado", "débil", "débil", "moderado", "débil…
#> $ oleaje_f2                <int> 310, 310, 310, 320, 310, 320, 320, 310, 320, 320, 310, 320
#> $ oleaje_descripcion2      <chr> "débil", "débil", "débil", "moderado", "débil", "moderado", "moderado", "débil…
#> $ tMaxima_value            <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ tMaxima_valor1           <int> 26, 27, 26, 26, 27, 27, 28, 28, 28, 28, 28, 28
#> $ sTermica_value           <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ sTermica_valor1          <int> 460, 460, 460, 460, 460, 460, 460, 460, 460, 460, 460, 460
#> $ sTermica_descripcion1    <chr> "calor agradable", "calor agradable", "calor agradable", "calor agradable", "c…
#> $ tAgua_value              <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ tAgua_valor1             <int> 24, 25, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24
#> $ uvMax_value              <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ uvMax_valor1             <int> 9, 8, 9, 9, 8, 9, 9, 9, 9, 9, 8, 9
#> $ tmaxima_value            <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ tmaxima_valor1           <int> 26, 27, 26, 26, 27, 27, 28, 28, 28, 28, 28, 28
#> $ stermica_value           <chr> "", "", "", "", "", "", "", "", "", "", "", ""
#> $ stermica_valor1          <int> 460, 460, 460, 460, 460, 460, 460, 460, 460, 460, 460, 460
