...
aemet_last_obs("9434")
#> # A tibble: 23 × 25
#>    idema   lon fint                 prec   alt  vmax    vv    dv   lat  dmax ubi    pres    hr stdvv    ts pres_…¹ tamin    ta tamax   tpr
#>    <chr> <dbl> <dttm>              <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <chr> <dbl> <dbl> <dbl> <dbl>   <dbl> <dbl> <dbl> <dbl> <dbl>
#>  1 9434  -1.00 2023-02-13 14:00:00     0   249   5.9   3.5   122  41.7   118 ZARA… 1003.    54   0.6  13.8   1034   10    11.6  11.7   2.7
#>  2 9434  -1.00 2023-02-13 15:00:00     0   249   6.5   3.3   116  41.7   108 ZARA… 1003     50   0.9  14.1   1034.  11.6  12.6  12.6   2.5
#>  3 9434  -1.00 2023-02-13 16:00:00     0   249   6.6   3.2   141  41.7   123 ZARA… 1003.    47   0.7  13.7   1033.  12.6  12.8  12.9   1.7
#>  4 9434  -1.00 2023-02-13 17:00:00     0   249   5.5   3.5   140  41.7   130 ZARA… 1003.    51   0.6  11     1034.  11.8  11.8  12.9   1.9
#>  5 9434  -1.00 2023-02-13 18:00:00     0   249   5     2      99  41.7   125 ZARA… 1003.    58   0.5   8     1034    9.6  11.3  11.8   3.4
#>  6 9434  -1.00 2023-02-13 19:00:00     0   249   4.9   0.9   106  41.7   345 ZARA… 1003.    65   0.3   5.2   1034.   8.3   8.3  12.4   2.1
#>  7 9434  -1.00 2023-02-13 20:00:00     0   249   1.1   0.6   269  41.7   275 ZARA… 1004.    70   0.1   4.1   1035.   6.3   6.3   8.3   1.3
#>  8 9434  -1.00 2023-02-13 21:00:00     0   249   1.8   1.4   189  41.7   195 ZARA… 1004.    76   0.3   2.4   1035.   5     5     6.3   1.1
#>  9 9434  -1.00 2023-02-13 22:00:00     0   249   1.5   1     224  41.7   190 ZARA… 1004.    78   0.1   2.3   1035.   4     4     5     0.4
#> 10 9434  -1.00 2023-02-13 23:00:00     0   249   2     0.7   173  41.7   185 ZARA… 1004.    83   0.2   1.5   1035.   3.7   3.8   4.1   1.3
#> # … with 13 more rows, 5 more variables: stddv <dbl>, inso <dbl>, tss5cm <dbl>, pacutp <dbl>, tss20cm <dbl>, and abbreviated variable
#> #   name ¹​pres_nmar
```
