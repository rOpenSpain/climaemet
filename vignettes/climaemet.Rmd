...
#>    <chr> <dbl> <dttm>              <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
#>  1 9434  -1.00 2025-07-31 03:00:00     0   249   9.9   6     315  41.7
#>  2 9434  -1.00 2025-07-31 04:00:00     0   249   7.9   3.7   313  41.7
#>  3 9434  -1.00 2025-07-31 05:00:00     0   249   6.3   3.2   282  41.7
#>  4 9434  -1.00 2025-07-31 06:00:00     0   249   6     3.9   314  41.7
#>  5 9434  -1.00 2025-07-31 07:00:00     0   249   5.4   3.5   311  41.7
#>  6 9434  -1.00 2025-07-31 08:00:00     0   249   9.2   5.7   313  41.7
#>  7 9434  -1.00 2025-07-31 09:00:00     0   249   9.7   5.6   318  41.7
#>  8 9434  -1.00 2025-07-31 10:00:00     0   249   8.9   5.2   316  41.7
#>  9 9434  -1.00 2025-07-31 11:00:00     0   249   8.8   3.9   310  41.7
#> 10 9434  -1.00 2025-07-31 12:00:00     0   249   8.2   3.4   321  41.7
#> 11 9434  -1.00 2025-07-31 13:00:00     0   249   7.2   3.6   306  41.7
#> 12 9434  -1.00 2025-07-31 14:00:00     0   249   7.6   3.9   305  41.7
#> 13 9434  -1.00 2025-07-31 15:00:00     0   249   7.2   4.1   304  41.7
#> # ℹ 16 more variables: dmax <dbl>, ubi <chr>, pres <dbl>, hr <dbl>,
#> #   stdvv <dbl>, ts <dbl>, pres_nmar <dbl>, tamin <dbl>, ta <dbl>,
...
#> Error in `httr2::req_perform()` at climaemet/R/aemet_api_query.R:295:3:
#> ! Failed to perform HTTP request.
#> Caused by error in `curl::curl_fetch_memory()`:
#> ! Timeout was reached [opendata.aemet.es]:
#> Operation timed out after 20015 milliseconds with 0 bytes received
