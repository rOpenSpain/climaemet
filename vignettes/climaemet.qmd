...
computer and reloaded every time you load the package. From now on, you can
...
From **v1.0.0** onward, **climaemet** returns its results in
[**tibble** format](https://tibble.tidyverse.org/). The functions also try to
parse fields into their correct types. For example, date and hour fields are
