...
Thanks for using climaemet! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/rOpenSpain/climaemet/issues/new).
...
requests](https://github.com/rOpenSpain/climaemet/issues) to make sure
