...
#> -15.100000  -5.300000  -1.600000  -1.399322   2.875000  13.600000
```
...
2001](#ref-ribeirojr2001)) and `gstat` ([Gräler, Pebesma, and Heuvelink
2016](#ref-gr%C3%A4ler2016)).
...
#> 2 max        14.0 17.6         13.6     6.69   7.77   738
```
...
Details
    ...
    #>  climaemet    * 1.4.2   2025-11-12 [1] local
...
Cressie, Noel A. C. 1993. *Statistics for Spatial Data*. Rev. ed. Wiley
...
“Spatio-Temporal Interpolation Using Gstat.” *The R Journal* 8 (1): 204.
...
Series in Probability and Statistics. Chichester, UK: John Wiley & Sons,
Ltd. <https://doi.org/10.1002/9781118762387>.
...
Ribeiro, Jr., Paulo J., and Peter J. Diggle. 2001. “geoR: A Package for
Geostatistical Analysis.” *R-NEWS* 1 (2).
<https://cran.r-project.org/doc/Rnews/Rnews_2001-2.pdf>.
...
Wackernagel, Hans. 1995. “Ordinary Kriging.” In, 74–81. Berlin,
