...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2025-12-24 08:50:18, 2025-12-24 08:50:18, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2025-12-24, 2025-12-25, 2025-12-26, 2025-12-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> 100, 110, 120, 100, 120, 110
#> $ estadoCielo_descripcion1 <chr> "despejado", "nuboso", "muy nuboso", "despeja…
#> $ estadoCielo_f2           <int> 140, 120, 110, 120, 140, 100
#> $ estadoCielo_descripcion2 <chr> "muy nuboso con lluvia", "muy nuboso", "nubos…
#> $ viento_value             <lgl> NA, NA, NA, NA, NA, NA
#> $ viento_f1                <int> 210, 220, 220, 210, 210, 210
#> $ viento_descripcion1      <chr> "flojo", "moderado", "moderado", "flojo", "fl…
...
#> $ oleaje_f1                <int> 310, 310, 310, 320, 310, 310
#> $ oleaje_descripcion1      <chr> "débil", "débil", "débil", "moderado", "débil…
...
#> $ tMaxima_valor1           <int> 15, 14, 15, 15, 14, 14
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 430, 430, 440, 440, 440, 440
#> $ sTermica_descripcion1    <chr> "muy fresco", "muy fresco", "fresco", "fresco…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 17, 17, 15, 16, 16, 16
