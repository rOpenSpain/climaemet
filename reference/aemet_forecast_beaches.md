...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2025-11-19 08:50:19, 2025-11-19 08:50:19, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2025-11-19, 2025-11-20, 2025-11-21, 2025-11-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> 100, 100, 110, 100, 110, 120
#> $ estadoCielo_descripcion1 <chr> "despejado", "despejado", "nuboso", "despejad…
#> $ estadoCielo_f2           <int> 100, 140, 110, 100, 130, 110
#> $ estadoCielo_descripcion2 <chr> "despejado", "muy nuboso con lluvia", "nuboso…
#> $ viento_value             <lgl> NA, NA, NA, NA, NA, NA
#> $ viento_f1                <int> 210, 220, 220, 210, 210, 220
#> $ viento_descripcion1      <chr> "flojo", "moderado", "moderado", "flojo", "fl…
#> $ viento_f2                <int> 210, 210, 230, 210, 220, 230
#> $ viento_descripcion2      <chr> "flojo", "flojo", "fuerte", "flojo", "moderad…
...
#> $ tMaxima_valor1           <int> 18, 16, 14, 18, 16, 13
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 440, 440, 430, 440, 440, 430
#> $ sTermica_descripcion1    <chr> "fresco", "fresco", "muy fresco", "fresco", "…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 22, 19, 19, 20, 19, 19
