...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2025-12-16 08:50:19, 2025-12-16 08:50:19, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2025-12-16, 2025-12-17, 2025-12-18, 2025-12-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> -116, 110, 100, 120, 100, 100
#> $ estadoCielo_descripcion1 <chr> "muy nuboso con lluvia", "nuboso", "despejado…
#> $ estadoCielo_f2           <int> 140, 100, 100, 140, 100, 100
#> $ estadoCielo_descripcion2 <chr> "muy nuboso con lluvia", "despejado", "despej…
...
#> $ viento_f2                <int> 220, 210, 210, 210, 220, 210
#> $ viento_descripcion2      <chr> "moderado", "flojo", "flojo", "flojo", "moder…
#> $ oleaje_value             <lgl> NA, NA, NA, NA, NA, NA
#> $ oleaje_f1                <int> 320, 320, 310, 310, 310, 310
#> $ oleaje_descripcion1      <chr> "moderado", "moderado", "débil", "débil", "dé…
#> $ oleaje_f2                <int> 320, 320, 310, 310, 310, 310
#> $ oleaje_descripcion2      <chr> "moderado", "moderado", "débil", "débil", "dé…
#> $ tMaxima_value            <lgl> NA, NA, NA, NA, NA, NA
#> $ tMaxima_valor1           <int> 18, 19, 19, 18, 19, 19
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 440, 440, 450, 440, 440, 440
#> $ sTermica_descripcion1    <chr> "fresco", "fresco", "suave", "fresco", "fresc…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 18, 17, 16, 18, 16, 16
