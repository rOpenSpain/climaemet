...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2026-08-26 08:50:18, 2026-08-26 08:50:18, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2026-08-26, 2026-08-27, 2026-08-28, 2026-08-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> 110, 110, 120, 110, 110, 120
#> $ estadoCielo_descripcion1 <chr> "nuboso", "nuboso", "muy nuboso", "nuboso", "…
#> $ estadoCielo_f2           <int> 110, 100, 120, 110, 110, 120
#> $ estadoCielo_descripcion2 <chr> "nuboso", "despejado", "muy nuboso", "nuboso"…
#> $ viento_value             <lgl> NA, NA, NA, NA, NA, NA
#> $ viento_f1                <int> 210, 210, 220, 210, 220, 210
#> $ viento_descripcion1      <chr> "flojo", "flojo", "moderado", "flojo", "moder…
#> $ viento_f2                <int> 220, 210, 210, 220, 210, 210
#> $ viento_descripcion2      <chr> "moderado", "flojo", "flojo", "moderado", "fl…
#> $ oleaje_value             <lgl> NA, NA, NA, NA, NA, NA
#> $ oleaje_f1                <int> 310, 320, 320, 310, 320, 320
#> $ oleaje_descripcion1      <chr> "débil", "moderado", "moderado", "débil", "mo…
#> $ oleaje_f2                <int> 310, 310, 310, 310, 320, 320
#> $ oleaje_descripcion2      <chr> "débil", "débil", "débil", "débil", "moderado…
#> $ tMaxima_value            <lgl> NA, NA, NA, NA, NA, NA
#> $ tMaxima_valor1           <int> 33, 31, 31, 34, 31, 32
...
#> $ tAgua_valor1             <int> 30, 29, 28, 29, 30, 28
