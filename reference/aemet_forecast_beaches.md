...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2026-08-28 09:00:19, 2026-08-28 09:00:19, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2026-08-28, 2026-08-29, 2026-08-30, 2026-08-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> 120, 100, 100, 120, 100, 100
#> $ estadoCielo_descripcion1 <chr> "muy nuboso", "despejado", "despejado", "muy …
...
#> $ viento_f1                <int> 220, 210, 210, 210, 210, 210
#> $ viento_descripcion1      <chr> "moderado", "flojo", "flojo", "flojo", "flojo…
...
#> $ oleaje_f1                <int> 320, 310, 310, 320, 310, 310
#> $ oleaje_descripcion1      <chr> "moderado", "débil", "débil", "moderado", "dé…
...
#> $ tMaxima_valor1           <int> 30, 31, 30, 31, 32, 31
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 460, 470, 470, 470, 470, 470
#> $ sTermica_descripcion1    <chr> "calor agradable", "calor moderado", "calor m…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 27, 29, 29, 28, 27, 29
