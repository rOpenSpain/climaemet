...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2025-12-17 08:50:18, 2025-12-17 08:50:18, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2025-12-17, 2025-12-18, 2025-12-19, 2025-12-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> 110, 100, 120, 100, 100, 120
#> $ estadoCielo_descripcion1 <chr> "nuboso", "despejado", "muy nuboso", "despeja…
#> $ estadoCielo_f2           <int> 100, 100, 120, 100, 100, 120
#> $ estadoCielo_descripcion2 <chr> "despejado", "despejado", "muy nuboso", "desp…
...
#> $ viento_f2                <int> 210, 210, 220, 220, 210, 210
#> $ viento_descripcion2      <chr> "flojo", "flojo", "moderado", "moderado", "fl…
#> $ oleaje_value             <lgl> NA, NA, NA, NA, NA, NA
#> $ oleaje_f1                <int> 320, 310, 310, 310, 310, 310
#> $ oleaje_descripcion1      <chr> "moderado", "débil", "débil", "débil", "débil…
#> $ oleaje_f2                <int> 320, 310, 310, 310, 310, 310
#> $ oleaje_descripcion2      <chr> "moderado", "débil", "débil", "débil", "débil…
#> $ tMaxima_value            <lgl> NA, NA, NA, NA, NA, NA
#> $ tMaxima_valor1           <int> 19, 19, 20, 19, 19, 20
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 440, 450, 450, 440, 440, 450
#> $ sTermica_descripcion1    <chr> "fresco", "suave", "suave", "fresco", "fresco…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 17, 17, 17, 16, 16, 16
