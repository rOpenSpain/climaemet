...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2026-04-25 08:50:19, 2026-04-25 08:50:19, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2026-04-25, 2026-04-26, 2026-04-27, 2026-04-…
#> $ nombre                   <chr> "Cala Major", "Cala Major", "Cala Major", "Pl…
#> $ estadoCielo_value        <lgl> NA, NA, NA, NA, NA, NA
#> $ estadoCielo_f1           <int> 110, 100, 100, 100, 100, 100
#> $ estadoCielo_descripcion1 <chr> "nuboso", "despejado", "despejado", "despejad…
#> $ estadoCielo_f2           <int> 120, 100, 100, 110, 100, 100
#> $ estadoCielo_descripcion2 <chr> "muy nuboso", "despejado", "despejado", "nubo…
...
#> $ tMaxima_valor1           <int> 21, 22, 23, 22, 23, 24
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 450, 450, 460, 450, 450, 460
#> $ sTermica_descripcion1    <chr> "suave", "suave", "calor agradable", "suave",…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 19, 19, 19, 18, 18, 19
#> $ uvMax_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ uvMax_valor1             <int> 7, 7, 8, 7, 7, 8
#> $ tagua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tagua_valor1             <int> 19, 19, 19, 18, 18, 19
#> $ tmaxima_value            <lgl> NA, NA, NA, NA, NA, NA
#> $ tmaxima_valor1           <int> 21, 22, 23, 22, 23, 24
