...
#> Rows: 6
#> Columns: 36
#> $ elaborado                <dttm> 2026-04-11 05:50:19, 2026-04-11 05:50:19, 20…
#> $ id                       <chr> "0704001", "0704001", "0704001", "0704007", "…
#> $ localidad                <chr> "07040", "07040", "07040", "07040", "07040", …
#> $ fecha                    <date> 2026-04-11, 2026-04-12, 2026-04-13, 2026-04-…
...
#> $ viento_f1                <int> 220, 230, 210, 210, 230, 210
#> $ viento_descripcion1      <chr> "moderado", "fuerte", "flojo", "flojo", "fuer…
#> $ viento_f2                <int> 220, 220, 210, 210, 220, 210
#> $ viento_descripcion2      <chr> "moderado", "moderado", "flojo", "flojo", "mo…
...
#> $ tMaxima_valor1           <int> 26, 21, 17, 26, 20, 16
#> $ sTermica_value           <lgl> NA, NA, NA, NA, NA, NA
#> $ sTermica_valor1          <int> 460, 450, 450, 460, 440, 440
#> $ sTermica_descripcion1    <chr> "calor agradable", "suave", "suave", "calor a…
#> $ tAgua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tAgua_valor1             <int> 17, 16, 15, 16, 15, 15
#> $ uvMax_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ uvMax_valor1             <int> 6, 6, 5, 6, 6, 5
#> $ tagua_value              <lgl> NA, NA, NA, NA, NA, NA
#> $ tagua_valor1             <int> 17, 16, 15, 16, 15, 15
#> $ tmaxima_value            <lgl> NA, NA, NA, NA, NA, NA
#> $ tmaxima_valor1           <int> 26, 21, 17, 26, 20, 16
