...
#> Rows: 10
#> Columns: 25
#> $ fecha       <date> 2025-12-09, 2025-12-10, 2025-12-11, 2025-12-12, 2025-12-1…
...
#> $ tmed        <dbl> 9.9, 10.8, 9.4, 9.2, 9.8, NA, NA, NA, NA, NA
#> $ prec        <dbl> 0.8, 1.4, 0.0, 0.0, 0.0, 7.9, 3.5, 0.0, 0.2, 0.0
#> $ tmin        <dbl> 4.5, 8.3, 8.0, 7.3, 4.9, NA, NA, NA, NA, NA
#> $ horatmin    <time> 05:30:00, 07:10:00, 22:40:00, 05:30:00, 23:59:00,       NA…
#> $ tmax        <dbl> 15.3, 13.4, 10.9, 11.2, 14.6, NA, NA, NA, NA, NA
#> $ horatmax    <time> 14:40:00, 22:20:00, 00:00:00, 15:00:00, 14:30:00,       NA…
#> $ dir         <dbl> 11, 22, 12, 14, 31, 99, 36, 24, 99, 30
#> $ velmedia    <dbl> 2.8, 1.7, 3.1, 2.8, 1.1, 1.1, 1.1, 1.1, 1.9, 1.7
#> $ racha       <dbl> 7.8, 8.3, 7.8, 6.1, 6.7, 3.3, 4.7, 5.3, 6.1, 6.7
#> $ horaracha   <chr> "09:40", "19:40", "16:10", "07:20", "15:00", "Varias", "22…
#> $ sol         <dbl> 7.5, 0.1, 0.0, 2.2, 5.5, NA, NA, NA, NA, NA
#> $ presMax     <dbl> 991.5, 995.2, 995.0, 994.0, 998.0, 944.5, 945.6, 945.4, 94…
#> $ horaPresMax <chr> "Varias", "23", "10", "Varias", "10", "Varias", "23", "09…
#> $ presMin     <dbl> 989.0, 989.2, 990.4, 989.3, 994.0, 942.6, 942.4, 941.4, 93…
#> $ horaPresMin <chr> "16", "Varias", "16", "07", "00", "14", "05", "24", "15",…
#> $ hrMedia     <dbl> 75, 95, 92, 92, 84, NA, NA, NA, NA, NA
#> $ hrMax       <dbl> 95, 98, 99, 100, 99, NA, NA, NA, NA, NA
#> $ horaHrMax   <time> 05:50:00, 08:20:00, 08:30:00, 05:30:00, 09:00:00,       NA…
#> $ hrMin       <dbl> 58, 82, 88, 82, 67, NA, NA, NA, NA, NA
#> $ horaHrMin   <time> 15:00:00, 00:00:00, 12:00:00, 14:50:00, 15:00:00,       NA…
