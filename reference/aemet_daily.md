...
#> Rows: 8
#> Columns: 26
#> $ fecha       <date> 2026-07-15, 2026-07-16, 2026-07-17, 2026-07-18, 2026-07-1…
...
#> $ tmed        <dbl> 33.0, 31.2, 30.0, 29.3, 27.8, 28.1, 27.2, 28.2
#> $ prec        <dbl> 0, 0, 0, 0, 0, 0, 0, 0
#> $ tmin        <dbl> 24.2, 24.2, 22.7, 22.0, 20.9, 22.2, 20.4, 21.3
#> $ horatmin    <time> 05:10:00, 06:10:00, 04:30:00, 05:00:00, 05:40:00, 06:00:00…
#> $ tmax        <dbl> 41.9, 38.2, 37.3, 36.6, 34.8, 34.0, 34.1, 35.2
#> $ horatmax    <time> 17:20:00, 16:20:00, 16:00:00, 17:20:00, 14:50:00, 14:50:00…
#> $ dir         <dbl> 31, 31, 30, 29, 28, 25, 25, 23
#> $ velmedia    <dbl> 3.6, 4.7, 4.2, 2.8, 2.2, 3.6, 2.5, 2.5
#> $ racha       <dbl> 10.3, 15.3, 13.9, 13.9, 10.3, 11.7, 10.6, 8.9
#> $ horaracha   <chr> "23:30", "23:00", "Varias", "01:20", "13:40", "15:20", "12…
#> $ sol         <dbl> 13.1, 10.7, 13.6, 13.1, NA, NA, NA, NA
#> $ presMax     <dbl> 987.4, 986.8, 987.3, 986.6, 943.6, 941.7, 941.8, 939.6
#> $ horaPresMax <chr> "07", "07", "07", "07", "09", "08", "08", "10"
#> $ presMin     <dbl> 983.5, 981.1, 981.7, 980.4, 940.7, 939.5, 938.3, 936.8
#> $ horaPresMin <chr> "17", "17", "17", "17", "Varias", "Varias", "18", "18"
#> $ hrMedia     <dbl> 35, 42, 36, 39, 34, 29, 31, 25
#> $ hrMax       <dbl> 83, 64, 63, 65, 57, 57, 55, 42
#> $ horaHrMax   <chr> "03:40", "06:10", "Varias", "04:50", "06:00", "06:20", "06…
#> $ hrMin       <dbl> 9, 21, 18, 21, 20, 20, 19, 14
#> $ horaHrMin   <chr> "17:00", "18:20", "16:30", "17:40", "Varias", "Varias", "…
