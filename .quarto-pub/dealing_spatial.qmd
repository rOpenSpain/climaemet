...
abstract: >
  ...
  examples use **sf**, **terra**, **gstat**, **geoR**, **climaemet**,
  **mapSpain** and **tidyterra**.
...
key-points:
  ...
  - Uses modern R spatial packages, including **sf**, **terra**, **gstat** and
    **tidyterra**.
...
**geoR** [@ribeirojr2001] and **gstat** [@pebesma2004], including the extensions
...
According to @wackernagel1995, it estimates a value at a point of a region for
