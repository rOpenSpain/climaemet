...
abstract: >
  ...
  reference systems, exploratory spatial analysis, semivariogram modelling,
  ordinary kriging, inverse distance weighting, and cross-validation. The
  examples rely on the modern R spatial ecosystem, including sf, terra, gstat,
  geoR, climaemet, mapSpain and tidyterra.
...
key-points:
  - Introduces the main concepts of exploratory spatial data analysis (ESDA) in R.
  - Demonstrates semivariogram modelling and ordinary kriging using real AEMET data.
...
To download data from AEMET, you need a free [API
...
kriging in a local neighborhood, point kriging, block kriging and conditional
simulation.
...
which a variogram is known, using data in the neighborhood of the estimation
location.
