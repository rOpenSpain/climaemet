...
This outlines how to propose a change to climaemet. For a detailed
...
Please note that the climaemet project is released with a [Contributor
Code of
Conduct](https://ropenspain.github.io/climaemet/CODE_OF_CONDUCT.md). By
